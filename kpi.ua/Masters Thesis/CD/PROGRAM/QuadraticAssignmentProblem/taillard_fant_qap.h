...
static const int m = 2147483647;static const int m2 = 2145483479; 
static const int a12= 63308;	static const int q12=33921; static const int r12=12979; 
static const int a13=-183326;	static const int q13=11714; static const int r13=2883; 
static const int a21= 86098;	static const int q21=24919; static const int r21= 7417; 
static const int a23=-539608;	static const int q23= 3976; static const int r23=2071;
...
// memory update
void update_trace(int n, type_vector p, vector<int> & best_p,
...
void generate_solution_trace(int n, type_vector p, type_matrix trace)
{
  ...
  free(sum_trace);
		              ...
		              const clock_t timeLimit = numeric_limits<clock_t>::max())	// Max execution time limit (ms) after start as stop criterion
	{
		...
		int  n = size;                          // size of the problem
		int cost;			                    // cost of current solution, best cost
		type_matrix a, b;                       // flow and distance matrices
		type_vector p;			                // current solution and best solution
		type_matrix trace;                      // ant memory
		int increment, R = 6;                   // parameter for managing the traces
		int k;				                    // iteration counters
		...
		for (long iteration = 0; iteration < numberOfIterations && clock() - start_clock < timeLimit; iteration++)
		{
			...
			if (cost < best.cost)
			{
				...
				// Memory update
				update_trace(n, p, best.solution, &increment, R, trace);
		}
